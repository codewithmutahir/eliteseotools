...
export default function TextExpanderPage() {
  ...
  return (
    <ToolLayout
      title="Text Expander"
      description="Make your text longer and more detailed while improving the writing quality and engagement."
    >
      <div className="space-y-4">
        <div>
          <label className="text-sm font-medium mb-2 block">Input Text</label>
          <Textarea
            placeholder="Enter text to expand and improve..."
            value={inputText}
        ...
        <div className="flex gap-2">
          <Button onClick={handleExpand} disabled={loading || !inputText.trim()}>
            {loading ? (
              <>
        ...
        {outputText && (
          ...
          >
            <div className="flex justify-between items-center">
              <label className="text-sm font-medium">Expanded Text</label>
